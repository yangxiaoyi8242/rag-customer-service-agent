...
echo ================================================
echo Windows本地RAG客户问答Agent (Web版本)启动脚本
echo ================================================
echo 
...
rem 安装依赖
pip install -q requests numpy faiss-cpu langchain sentence-transformers fastapi uvicorn python-multipart
